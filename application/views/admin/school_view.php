                                        ...
                                        <div class="panel-heading">
                                            <div class="pull-right action-buttons">
                                                <div class="btn-group pull-right">
                                                    <button type="button" class="btn btn-default btn-xs" data-toggle="collapse" data-target="#add"> <span class="glyphicon glyphicon-plus-sign">เพิ่มข้อมูลโรงเรียน</button>
                                                </div>
                                            </div>
                                            <span class="glyphicon glyphicon-cog"></span><FONT SIZE=3><b> จัดการข้อมูลโรงเรียน</b></FONT>
                                        </div>
                                        <div class="panel-body">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <form method="post" action="add" class="form-horizontal">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" name="txtName" value="" placeholder="ชื่อโรงเรียน" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-4 control-label">ที่อยู่โรงเรียน</label>
                                                                <div class="col-sm-6">
                                                                    <textarea class="form-control" rows="6" name="txtAddress" placeholder="รายละเอียดต่างๆ" data-validation="required"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-4 control-label">เบอร์โทรศัพท์</label>
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" name="txtTel" value="" placeholder="เบอร์โทรศัพท์" data-validation="required">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-4 control-label">เว็บไซต์</label>
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" name="txtWeb" value="" placeholder="เว็บไซต์">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" name="txtTeacher" value="" placeholder="ครูแนะแนว">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-4 control-label">เบอร์ติดต่อครูแนะแนว</label>
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" name="txtTelTeacher" value="" placeholder="เบอร์ติดต่อครูแนะแนว">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="detail" class="col-sm-4 control-label">Email ครูแนะแนว</label>
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" name="txtEmail" value="" placeholder="Email ครูแนะแนว">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <?php if(count($rs)>0):?>
                                                    <?php foreach ($rs as $r):?>
                                                        <tr>
                                                            <td><?php echo $r->sch_name ?></td>
                                                            <td><?php echo $r->sch_address ?></td>
                                                            <td><?php echo $r->sch_tel ?></td>
                                                            <td> 
                                                                <a 
                                                                    type="button" class="btn btn-info btn-xs" href="<?php echo  base_url('admin_manage_school/viewone/'.$r->sch_id); ?>" role="button">
                                                                    <span class="glyphicon glyphicon-eye-open"></span> รายละเอียด
                                                                </a>
                                                                <a 
                                                                    type="button" class="btn btn-warning btn-xs" href="<?php echo  base_url('admin_manage_school/viewedit/'.$r->sch_id); ?>" role="button">
                                                                    <span class="glyphicon glyphicon-edit"></span> แก้ไข
                                                                </a>                                       
                                                                <button type="button" class="btn btn-danger btn-xs">
                                                                    <a href="#myModal" class="trash" data-id="<?php echo $r->sch_id; ?>"  data-toggle="modal" class="btn btn-info" role="button" ><font color="#FFFFF">ลบ </font></a>
                                                                </button>                                                              
